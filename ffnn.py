...
class FFNN(nn.Module):
    ...
    def forward(self, input_vector):
        ...
        temp_vector1=self.W1(input_vector)
        h1=self.activation(temp_vector1)

        # [to fill] obtain output layer representation
        temp_vector2=self.W2(h1)

        # [to fill] obtain probability dist.
        predicted_vector=self.softmax(temp_vector2)
...
def load_data(train_data, val_data, test_data):
    ...
    with open(test_data) as testing_f:
...
if __name__ == "__main__":
    ...
    #Command to run:
    #python ffnn.py --hidden_dim 8 --epochs 10 --train_data D:\Academics\Fall_23\Natural_Language_Processing\Assignment2\assignment2\training.json --val_data validation.json